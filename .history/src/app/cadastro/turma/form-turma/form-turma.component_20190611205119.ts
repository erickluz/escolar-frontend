...
export class FormTurmaComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.professoresA.push(this.formBuilder.control(new Professor(null, null, null, null, null, null, null, null, null, null, null, null)))
  ...
  createFormAula(aula: Aula, professor: Professor) {
    this.formAula = this.formBuilder.group({
      ...
      professoresA: this.formBuilder.array([]),
      disciplina: [aula.disciplina]
    });
  }

  get professoresA() {
    return this.formAula.get('professoresA') as FormArray;
 }
